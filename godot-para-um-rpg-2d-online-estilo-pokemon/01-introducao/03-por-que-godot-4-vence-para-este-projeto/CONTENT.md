...
1. [Cena-como-Árvore: o Paradigma Central do Godot](01-cena-como-arvore-o-paradigma-central-do-godot/CONTENT.md) — por que modelar um RPG 2D como árvore de nodes compostos encaixa naturalmente em mapas, NPCs, UI e o jogo como um todo.
2. [GDScript: Ergonomia e Integração com a Engine](02-gdscript-ergonomia-e-integracao-com-a-engine/CONTENT.md) — sintaxe Python-like, tipagem dinâmica, hot reload e integração profunda com nodes e signals — custo de aprendizado quase zero para quem já programa.
3. [Licença MIT e Modelo Sem Royalties](03-licenca-mit-e-modelo-sem-royalties/CONTENT.md) — o que a licença permissiva significa na prática para um projeto pessoal de longa duração que pode ou não se tornar produto.
4. [API de Multiplayer de Alto Nível Nativa](04-api-de-multiplayer-de-alto-nivel-nativa/CONTENT.md) — `MultiplayerAPI`, `MultiplayerSpawner` e `MultiplayerSynchronizer` como camada pronta, com ENet e WebSocket como transports, em contraste com a montagem manual exigida por outras engines.
5. [Footprint Enxuto e Ciclos de Iteração Rápidos](05-footprint-enxuto-e-ciclos-de-iteracao-rapidos/CONTENT.md) — editor de ~120MB, abertura em segundos e hot reload de cenas como acelerador de aprendizado para quem nunca abriu uma engine.
6. [Limitações Honestas do Godot 4 no Contexto Multiplayer](06-limitacoes-honestas-do-godot-4-no-contexto-multiplayer/CONTENT.md) — ausência de client-side prediction/rollback nativo, teto prático de ~40 jogadores simultâneos, ferramentas auxiliares por conta do desenvolvedor — e por que isso não invalida a escolha para este alvo.
